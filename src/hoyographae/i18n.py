...
TRANSLATIONS = {
    "zh_CN": {
        ...
        "font.current": "当前：{name}  ·  {count:,} 个 Unicode 映射\n{path}",
        "glyph.title": "字形查阅",
        "glyph.subtitle": "通过 fontTools 读取 cmap；可按字符、U+ 编号或 Unicode 名称筛选。",
    ...
    "en_US": {
        ...
        "font.current": "Current: {name}  ·  {count:,} Unicode mappings\n{path}",
        "glyph.title": "Glyph Browser",
        "glyph.subtitle": "Read the cmap with fontTools and filter by character, U+ value, or Unicode name.",
